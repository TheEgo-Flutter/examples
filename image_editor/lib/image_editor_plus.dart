...
import 'package:image_editor/layers/background_layer.dart';
...
import 'package:image_editor/modules/text.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            const BackButton(),
            const Spacer(),
            if (images.length < widget.maxLength && widget.features.pickFromGallery)
              IconButton(
            ...
            if (images.length < widget.maxLength && widget.features.captureFromCamera)
              IconButton(
                padding: const EdgeInsets.symmetric(horizontal: 8),
