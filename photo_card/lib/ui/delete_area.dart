...
class DeleteArea extends StatelessWidget {
  const DeleteArea({
    super.key,
    required this.currentFingerPosition,
  });

  final Offset currentFingerPosition;
    ...
    return Positioned(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: !CardRect().deleteRect.contains(currentFingerPosition) ? Colors.transparent : Colors.red,
          boxShadow: const [
            BoxShadow(
